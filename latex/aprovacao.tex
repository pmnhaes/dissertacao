\begin{folhadeaprovacao}
    ...
    \bigbreak
    \assinatura{Prof.  (Doutor, ) - UENF}
    \bigbreak
    \assinatura{Prof.  (Doutor, ) - UENF}
    \bigbreak
    \assinatura{Prof. Simone Vasconcelos Silva (Doutora, Computação) - UFF \\ Co-orientadora}
    \bigbreak
    \assinatura{Prof. Rogério Atem Carvalho (Doutor, Ciências de Engenharia) - UENF \\ Orientador}
