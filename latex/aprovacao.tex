\begin{folhadeaprovacao}
    ...
    \assinatura{Profa. Annabell Del Real Tamariz (Doutor(a), Engenharia Elétrica) - UENF}
    \bigbreak
    \assinatura{Profa. Simone Vasconcelos Silva (Doutora, Computação) - IFF \\ Coorientadora}
    \bigbreak
